...
exports.max = exports.min = exports.inRange = exports.lt = exports.lte = exports.gt = exports.gte = exports.eq = exports.add = exports.endOf = exports.startOf = exports.hours = exports.minutes = exports.seconds = exports.milliseconds = void 0;
...
var _jalaliMoment = _interopRequireDefault(require("jalali-moment"));
...
function month(date, args) {
  var m = (0, _jalaliMoment.default)(date);
...
function firstVisibleDay(date) {
  var md = _jalaliMoment.default.from(date);

  md.locale('fa');
  var firstOfMonth = md.startOf('month').startOf('week');
...
function lastVisibleDay(date) {
  ...
  md.locale('fa');
  var endOfMonth = md.endOf('month').endOf('week');
