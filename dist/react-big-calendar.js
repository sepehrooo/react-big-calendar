(function (global, factory) {
  ...
  */
  ...
  function month$1(date, args) {
    var m = jalaliMoment(date);
    ...
    _proto.render = function render() {
      ...
      return React__default.createElement("div", {
        ...
        return React__default.createElement(Wrapper, {
          ...
          style: style,
          className: clsx('rbc-day-bg', className, selected && 'rbc-selected-cell', eq(date, current, 'day') && 'rbc-today', currentDate && month$1(currentDate) !== month$1(date) && 'rbc-off-range-bg')
        }));
      }));
    };
    ...
    function MonthView() {
      ...
      _this.readerDateHeading = function (_ref) {
        ...
        var _this$props2 = _this.props,
            ...
            localizer = _this$props2.localizer;
        var isOffRange = month$1(date) !== month$1(currentDate);
